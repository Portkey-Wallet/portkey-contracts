...
public partial class CAContractTests
{
    ...
    [Fact]
    public async Task AddGuardianWithZkTestLoginWithZkAndAddEmailGuardian()
    {
        var caHash = await CreateHolderWithZkLogin2();
        ...
        var input = new AddGuardianInput
        {
            ...
            GuardianToAdd = new GuardianInfo
            {
                ...
                VerificationInfo = new VerificationInfo
                {
                    Id = Hash.LoadFromHex("53961cca496a1cfaa7bf2dda210afb4f6430283cce4239be099ade5647091928"),
                    // Signature = signature1,
                    VerificationDoc = ""
                    //     $"{0},{_guardian1.ToHex()},{verificationTime.AddSeconds(5)},{VerifierAddress1.ToBase58()},{salt},{operationType},{MainChainId}"
                },
